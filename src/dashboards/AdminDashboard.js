...
export default function AdminDashboard() {
  const [totalRequerimento, setTotalRequerimento] = useState(null);
  const [totalNotasEntrada, setTotalNotasEntrada] = useState(null);
  const [totalNotasSaidas, setTotalNotasSaidas] = useState(null);
  const [totalAudiencias, setTotalAudiencias] = useState(null);
  useEffect(() => {
    TotalAudiencias();
    TotalRequerimento();
    TotalNotasEntrada();
